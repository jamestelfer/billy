...
// buildVersion always returns a non-empty version string: `--version` must
// print something useful for a plain `go build` too, where the ldflags above
// are never applied (R4).
